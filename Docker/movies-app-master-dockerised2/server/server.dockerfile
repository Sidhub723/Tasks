...
# Ne install our application with its dependencies(express) here and create our custom image which is a combiantion of the base nodejs image and also our additional source code
...
# The name of the container is the same name as that of the service (by default)
